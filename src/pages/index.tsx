import Credit from "@/components/dom/Credit";
import Header from "@/components/dom/Header";
import QA from "@/components/dom/QA";
  ...
  return (
    <>
      ...
      <p className="credits">
        ...
        />
        <Credit name={"The God of Kino"} credit={"Writing the guide."} />
        <Credit
          name={
        ...
        />{" "}
        Special thanks to <a href="https://twitter.com/pmndrs">Poimandres</a>{" "}
        for answering all the dumb questions I had while programming and
        creating the amazing libraries used in this project.
      </p>
      <br />
    </>
  );
